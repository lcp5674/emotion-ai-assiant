...
export const api = {
  ...
  admin: {
    ...
    dashboard: (): Promise<any> => request.get('/admin/dashboard'),
    users: (params?: { page?: number; page_size?: number; keyword?: string; level?: string }): Promise<any> => request.get('/admin/users', { params }),
    userDetail: (id: number): Promise<any> => request.get(`/admin/users/${id}`),
    updateUser: (id: number, data: any): Promise<any> => request.put(`/admin/users/${id}`, data),
    deleteUser: (id: number): Promise<any> => request.delete(`/admin/users/${id}`),
    conversationStats: (): Promise<any> => request.get('/admin/conversations/stats'),
    dailyStats: (params?: { days?: number }): Promise<any> => request.get('/admin/stats/daily', { params }),
    userGrowthStats: (params?: { period?: string }): Promise<any> => request.get('/admin/stats/user-growth', { params }),
    activityStats: (params?: { days?: number }): Promise<any> => request.get('/admin/stats/activity', { params }),
    contentStats: (): Promise<any> => request.get('/admin/stats/content'),
    membershipStats: (): Promise<any> => request.get('/admin/stats/membership'),
    systemStats: (): Promise<any> => request.get('/admin/stats/system'),
    auditQueue: (params?: { status?: string; risk_level?: string; page?: number; page_size?: number }): Promise<any> => request.get('/admin/audit-queue', { params }),
    reviewAudit: (id: number, data: { status: string; note?: string }): Promise<any> => request.post(`/admin/audit-queue/${id}/review`, data),
    auditStats: (): Promise<any> => request.get('/admin/audit-queue/stats'),
    articles: (params?: { page?: number; page_size?: number; status?: string; category?: string; keyword?: string }): Promise<any> => request.get('/admin/articles', { params }),
    createArticle: (data: any): Promise<any> => request.post('/admin/articles', data),
    updateArticle: (id: number, data: any): Promise<any> => request.put(`/admin/articles/${id}`, data),
    deleteArticle: (id: number): Promise<any> => request.delete(`/admin/articles/${id}`),
    banners: (): Promise<any> => request.get('/admin/banners'),
    createBanner: (data: any): Promise<any> => request.post('/admin/banners', data),
    updateBanner: (id: number, data: any): Promise<any> => request.put(`/admin/banners/${id}`, data),
    deleteBanner: (id: number): Promise<any> => request.delete(`/admin/banners/${id}`),
    announcements: (): Promise<any> => request.get('/admin/announcements'),
    createAnnouncement: (data: any): Promise<any> => request.post('/admin/announcements', data),
    updateAnnouncement: (id: number, data: any): Promise<any> => request.put(`/admin/announcements/${id}`, data),
    deleteAnnouncement: (id: number): Promise<any> => request.delete(`/admin/announcements/${id}`),
    roles: (): Promise<any> => request.get('/admin/roles'),
    createRole: (data: any): Promise<any> => request.post('/admin/roles', data),
    updateRole: (id: number, data: any): Promise<any> => request.put(`/admin/roles/${id}`, data),
    deleteRole: (id: number): Promise<any> => request.delete(`/admin/roles/${id}`),
    permissions: (): Promise<any> => request.get('/admin/permissions'),
    assignPermissions: (roleId: number, data: { permission_ids: number[] }): Promise<any> => request.post(`/admin/roles/${roleId}/permissions`, data),
    assignRoles: (userId: number, data: { role_ids: number[] }): Promise<any> => request.post(`/admin/users/${userId}/roles`, data),
    userRoles: (userId: number): Promise<any> => request.get(`/admin/users/${userId}/roles`),
  },
